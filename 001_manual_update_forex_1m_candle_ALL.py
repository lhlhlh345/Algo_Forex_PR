...
# Truncate the [YOUR 1-MIN TABLE] table
truncate_table(conn, '[YOUR 1-MIN TABLE]')
...
for x in range (0, numdays):
    dateList.append(date_time - dt.timedelta(days = x))

# convert the dates to unix timesta
for x in dateList:
    dateList_unix.append(int(x.timestamp()))

dateList_unix.reverse()
